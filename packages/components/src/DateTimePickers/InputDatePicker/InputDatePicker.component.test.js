...
describe('InputDatePicker', () => {
	describe('focus/blur', () => {
		it('should open picker on focus', () => {
			// given
			const wrapper = mount(<InputDatePicker id="my-picker" />);
		...
		it('should trigger props.onBlur', () => {
			...
			const wrapper = mount(<InputDatePicker id="my-picker" onBlur={onBlur} />);
	...
	describe('onChange', () => {
		it('should trigger props.onChange', () => {
			...
			const wrapper = mount(<InputDatePicker id="my-picker" onChange={onChange} useTime />);
		...
		it('should NOT close from input change', () => {
			// given
			const wrapper = mount(<InputDatePicker id="my-picker" onChange={jest.fn()} />);
			wrapper.simulate('focus');
			expect(getOverlay(wrapper).exists()).toBe(true);
		...
		it('should close in form mode submit', () => {
			// given
			const wrapper = mount(<InputDatePicker id="my-picker" onChange={jest.fn()} formMode />);
			wrapper.simulate('focus');
			expect(getOverlay(wrapper).exists()).toBe(true);
