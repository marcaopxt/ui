...
import theme from './VirtualTree.container.scss';
import VirtualizedList from '../VirtualizedList';
import I18N_DOMAIN_COMPONENTS from '../constants';
import Dropdown from '../MultiSelect/Dropdown.container';
import VirtualTree from './VirtualTree.component';
...
class VirtualTreeDropdown extends React.Component {
	static displayName = 'VirtualTreeDropdown';
	static theme = theme;
	static defaultProps = {
	...
	render() {
		...
		return (
			...
			>
				...
				/>
				{this.state.showDropdown && <VirtualTree nodes={items} selectAllButton />}
			</div>
		);
	}
}

export default withTranslation(I18N_DOMAIN_COMPONENTS)(VirtualTree);
