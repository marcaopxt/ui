...
export default function Widget(props) {
	...
	if (onChange) {
		...
		eventsProps.onChange = function onValueChange(...args) {
			...
			// * on native elements, the onChange is triggered AFTER the rerender,
			// 		so oldProperties contains the new ones
			// * on controlled elements, using rhf.setValue, the onChange is triggered BEFORE the reRender
